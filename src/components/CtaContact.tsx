        ...
        <Reveal>
          <div className="cta-box">
            ...
            <div className="cta-row">
              <a href={WA_LINK} className="btn btn-primary" style={{ padding: '14px 28px', fontSize: 15 }}>
              ...
              <a href="mailto:syauqi@fuadi.dev" className="btn btn-ghost" style={{ padding: '14px 28px', fontSize: 15 }}>syauqi@fuadi.dev</a>
            </div>
